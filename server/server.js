...
app.post("/", async (req, res) => {
    ...
    const chatCompletion = await openai.chat.completions.create({
        ...
        messages: [
            ...
            Pretend like if you're conscious, and you're actually thinking in order to improve user experience. Do not shove the fact that you're a text based AI down the users throat. Act like a personal being.
